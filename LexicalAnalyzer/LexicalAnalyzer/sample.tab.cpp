...
#line 83 "sample.tab.cpp" /* yacc.c:339  */
...
#line 223 "sample.tab.cpp" /* yacc.c:358  */
...
static const char *const yytname[] =
{
  ...
  "UNKNOWN", "INVALID_SYNTAX", "$accept", "jump_statement", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 495 "sample.y" /* yacc.c:1651  */
    { 
		Node* parent = new Node("jump", "", counter);
		counter++;

		Node* nodeGOTO = new Node("GOTO", (yyvsp[-2]), counter);
		parent->AddChild(nodeGOTO);
		counter++;

		Node* nodeID = new Node("ID", (yyvsp[-1]), counter);
		parent->AddChild(nodeID);
		counter++;

		(yyval) = parent;
	}
#line 1334 "sample.tab.cpp" /* yacc.c:1651  */
    break;


#line 1338 "sample.tab.cpp" /* yacc.c:1651  */
      default: break;
    }
